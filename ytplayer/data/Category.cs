...
namespace ytplayer.data {
    ...
    public class CategoryList {
        ...
        public void Initialize() {
            ...
            Create("Anime", Colors.DarkBlue, 25, "M 12 11.18C 15.3 8.18 17 6.64 17 4.69 17 3.19 15.75 2 14.25 2 13.39 2 12.57 2.36 12 3 11.43 2.36 10.61 2 9.69 2 8.19 2 7 3.25 7 4.75 7 6.64 8.7 8.18 12 11.18M 11.18 12C 8.18 8.7 6.64 7 4.69 7 3.19 7 2 8.25 2 9.75 2 10.61 2.36 11.43 3 12 2.36 12.57 2 13.39 2 14.31 2 15.81 3.25 17 4.75 17 6.64 17 8.18 15.3 11.18 12M 12.83 12C 15.82 15.3 17.36 17 19.31 17 20.81 17 22 15.75 22 14.25 22 13.39 21.64 12.57 21 12 21.64 11.43 22 10.61 22 9.69 22 8.19 20.75 7 19.25 7 17.36 7 15.82 8.7 12.83 12M 12 12.82C 8.7 15.82 7 17.36 7 19.31 7 20.81 8.25 22 9.75 22 10.61 22 11.43 21.64 12 21 12.57 21.64 13.39 22 14.31 22 15.81 22 17 20.75 17 19.25 17 17.36 15.3 15.82 12 12.82Z");
            Create("Drama", Colors.LimeGreen, 27, "M 12 2.1A 5,5,0,0,1,17,7 5,5,0,0,1,12,12 5,5,0,0,1,7,7 5,5,0,0,1,12,2.1M 12 14.5C 17.5 14.5 21.9 16.7 21.9 19.4V 21.9H 2.1V 19.4C 2.1 16.7 6.5 14.5 12 14.5Z");
            ...
            Create("Training", Colors.DeepSkyBlue, 70, "M 13.5 5.5C 14.59 5.5 15.5 4.58 15.5 3.5 15.5 2.38 14.59 1.5 13.5 1.5 12.39 1.5 11.5 2.38 11.5 3.5 11.5 4.58 12.39 5.5 13.5 5.5M 9.89 19.38L 10.89 15 13 17V 23H 15V 15.5L 12.89 13.5 13.5 10.5C 14.79 12 16.79 13 19 13V 11C 17.09 11 15.5 10 14.69 8.58L 13.69 7C 13.29 6.38 12.69 6 12 6 11.69 6 11.5 6.08 11.19 6.08L 6 8.28V 13H 8V 9.58L 9.79 8.88 8.19 17 3.29 16 2.89 18 9.89 19.38Z");
            Create("Health", Colors.IndianRed, 80, "M 18 14H 14V 18H 10V 14H 6V 10H 10V 6H 14V 10H 18M 20 2H 4C 2.9 2 2 2.9 2 4V 20C 2 21.1 2.9 22 4 22H 20C 21.1 22 22 21.1 22 20V 4C 22 2.9 21.1 2 20 2M 20 20H 4V 4H 20V 20Z");
